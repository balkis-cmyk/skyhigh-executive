...
export function Panel({
  ...
  return (
    <aside
      className={cn(
        // Leaflet panes go up to z-index 1000 — we must stay above that
        // even if the map's stacking-context isolation breaks somewhere.
        // Modal dialogs use the native top layer so they still cover this.
        "fixed top-16 bottom-3 right-3 z-[1100] flex flex-col",
