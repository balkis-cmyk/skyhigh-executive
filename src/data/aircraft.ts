...
export const AIRCRAFT: AircraftSpec[] = [
  ...
  // ─── Unlocks (PRD §6.2) ─────────────────────────────────────
  { id: "A380-800", name: "Airbus A380-800", family: "passenger", unlockQuarter: 5,
    ...
    ecoUpgradeUsd: 20_000_000, note: "Mega-capacity. Economics depend entirely on load factor." },
  { id: "B787-9", name: "Boeing 787-9 Dreamliner", family: "passenger", unlockQuarter: 8,
    seats: { first: 0, business: 48, economy: 248 }, rangeKm: 14_140,
    fuelBurnPerKm: 4.2, buyPriceUsd: 80_000_000, leasePerQuarterUsd: 655_000,
    ecoUpgradeUsd: 8_000_000, note: "20% fuel saving. Opens thin long-haul with premium yields." },
  { id: "A350-900", name: "Airbus A350-900 XWB", family: "passenger", unlockQuarter: 10,
    seats: { first: 0, business: 48, economy: 267 }, rangeKm: 15_000,
    fuelBurnPerKm: 4.0, buyPriceUsd: 90_000_000, leasePerQuarterUsd: 738_000,
    ecoUpgradeUsd: 9_000_000, note: "25% fuel saving. Best long-haul economics in fleet." },
  { id: "A320neo", name: "Airbus A320neo", family: "passenger", unlockQuarter: 12,
    seats: { first: 0, business: 24, economy: 156 }, rangeKm: 6500,
    fuelBurnPerKm: 2.8, buyPriceUsd: 28_000_000, leasePerQuarterUsd: 230_000,
    ecoUpgradeUsd: 2_800_000, note: "18% fuel saving over A320ceo. Modern-fleet flag counts." },
  { id: "A220-300", name: "Airbus A220-300", family: "passenger", unlockQuarter: 12,
    seats: { first: 0, business: 12, economy: 118 }, rangeKm: 6300,
    fuelBurnPerKm: 2.5, buyPriceUsd: 22_000_000, leasePerQuarterUsd: 180_000,
    ecoUpgradeUsd: 2_200_000, note: "Right-size for thin regional. Best narrow-body economics." },
  { id: "B737-MAX-8", name: "Boeing 737 MAX 8", family: "passenger", unlockQuarter: 14,
    ...
    ecoUpgradeUsd: 2_600_000, note: "14% fuel saving over 737-800. Modern-fleet flag counts." },
  { id: "B777X-9", name: "Boeing 777X-9", family: "passenger", unlockQuarter: 16,
    ...
    ecoUpgradeUsd: 18_000_000, note: "12% fuel saving over 777-200ER. Heavy-lift modern long-haul." },
  { id: "A321XLR", name: "Airbus A321XLR", family: "passenger", unlockQuarter: 17,
    seats: { first: 0, business: 24, economy: 196 }, rangeKm: 8700,
    fuelBurnPerKm: 3.4, buyPriceUsd: 32_000_000, leasePerQuarterUsd: 265_000,
    ecoUpgradeUsd: 3_200_000, note: "Transatlantic single-aisle. Opens thin long-haul at narrow-body economics." },
];
