...
const AIRCRAFT: AircraftSpec[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 80_000_000, leasePerQuarterUsd: 656_000,
  ...
  },
  {
    ...
    buyPriceUsd: 90_000_000, leasePerQuarterUsd: 738_000,
  ...
  },
  {
    ...
    buyPriceUsd: 105_000_000, leasePerQuarterUsd: 861_000,
    ecoUpgradeUsd: 10_500_000,
    cutoffRound: 36,
  },
  {
    ...
    buyPriceUsd: 210_000_000, leasePerQuarterUsd: 1_721_000,
    ecoUpgradeUsd: 21_000_000,
    cutoffRound: 24,
  },
  {
    ...
    buyPriceUsd: 230_000_000, leasePerQuarterUsd: 1_885_000,
    ecoUpgradeUsd: 23_000_000,
    cutoffRound: 18,
  },
  {
    ...
    buyPriceUsd: 55_000_000, leasePerQuarterUsd: 451_000,
  ...
  },
  {
    ...
    buyPriceUsd: 65_000_000, leasePerQuarterUsd: 533_000,
    ecoUpgradeUsd: 6_500_000,
    cutoffRound: 11,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 100_000_000, leasePerQuarterUsd: 820_000,
  ...
  },
  {
    ...
    buyPriceUsd: 240_000_000, leasePerQuarterUsd: 1_967_000,
    ecoUpgradeUsd: 24_000_000,
    cutoffRound: 13,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 175_000_000, leasePerQuarterUsd: 1_434_000,
  ...
  },
  {
    ...
    buyPriceUsd: 195_000_000, leasePerQuarterUsd: 1_598_000,
    ecoUpgradeUsd: 19_500_000,
    cutoffRound: 17,
  },
  {
    ...
    buyPriceUsd: 220_000_000, leasePerQuarterUsd: 1_803_000,
    ecoUpgradeUsd: 22_000_000,
    cutoffRound: 18,
  },
  {
    ...
    buyPriceUsd: 250_000_000, leasePerQuarterUsd: 2_049_000,
    ecoUpgradeUsd: 25_000_000,
    cutoffRound: 12,
  },
  {
    ...
    buyPriceUsd: 40_000_000, leasePerQuarterUsd: 328_000,
  ...
  },
  {
    ...
    buyPriceUsd: 45_000_000, leasePerQuarterUsd: 369_000,
  ...
  },
  {
    ...
    buyPriceUsd: 35_000_000, leasePerQuarterUsd: 287_000,
  ...
  },
  {
    ...
    buyPriceUsd: 42_000_000, leasePerQuarterUsd: 344_000,
  ...
  },
  {
    ...
    buyPriceUsd: 50_000_000, leasePerQuarterUsd: 410_000,
  ...
  },
  {
    ...
    buyPriceUsd: 25_000_000, leasePerQuarterUsd: 205_000,
    ecoUpgradeUsd: 2_500_000,
    cutoffRound: 13,
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 60_000_000, leasePerQuarterUsd: 492_000,
    ecoUpgradeUsd: 6_000_000,
    cutoffRound: 15,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 200_000_000, leasePerQuarterUsd: 1_639_000,
  ...
  },
  {
    ...
    buyPriceUsd: 270_000_000, leasePerQuarterUsd: 2_213_000,
    ecoUpgradeUsd: 27_000_000,
    cutoffRound: 13,
  },
  {
    ...
    buyPriceUsd: 285_000_000, leasePerQuarterUsd: 2_336_000,
    ecoUpgradeUsd: 28_500_000,
  },
  {
    ...
    buyPriceUsd: 115_000_000, leasePerQuarterUsd: 943_000,
  ...
  },
  {
    ...
    buyPriceUsd: 235_000_000, leasePerQuarterUsd: 1_926_000,
    ecoUpgradeUsd: 23_500_000,
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 275_000_000, leasePerQuarterUsd: 2_254_000,
    ecoUpgradeUsd: 27_500_000,
    cutoffRound: 30,
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 430_000_000, leasePerQuarterUsd: 3_525_000,
  ...
  },
  {
    ...
    buyPriceUsd: 450_000_000, leasePerQuarterUsd: 3_689_000,
    ecoUpgradeUsd: 45_000_000,
    cutoffRound: 27,
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 225_000_000, leasePerQuarterUsd: 1_844_000,
    ecoUpgradeUsd: 22_500_000,
  },
  {
    ...
    buyPriceUsd: 30_000_000, leasePerQuarterUsd: 246_000,
  ...
  },
  {
    ...
    buyPriceUsd: 150_000_000, leasePerQuarterUsd: 1_230_000,
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 370_000_000, leasePerQuarterUsd: 3_033_000,
    ecoUpgradeUsd: 37_000_000,
    cutoffRound: 33,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 385_000_000, leasePerQuarterUsd: 3_156_000,
  ...
  },
  {
    ...
    buyPriceUsd: 95_000_000, leasePerQuarterUsd: 779_000,
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 260_000_000, leasePerQuarterUsd: 2_131_000,
    ecoUpgradeUsd: 26_000_000,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 125_000_000, leasePerQuarterUsd: 1_025_000,
    ecoUpgradeUsd: 12_500_000,
  },
  {
    ...
    buyPriceUsd: 110_000_000, leasePerQuarterUsd: 902_000,
  ...
  },
  {
    ...
    buyPriceUsd: 120_000_000, leasePerQuarterUsd: 984_000,
    ecoUpgradeUsd: 12_000_000,
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 325_000_000, leasePerQuarterUsd: 2_664_000,
    ecoUpgradeUsd: 32_500_000,
  },
  {
  ...
  },
  {
    ...
    buyPriceUsd: 295_000_000, leasePerQuarterUsd: 2_418_000,
    ecoUpgradeUsd: 29_500_000,
  },
  {
    ...
    buyPriceUsd: 75_000_000, leasePerQuarterUsd: 615_000,
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 140_000_000, leasePerQuarterUsd: 1_148_000,
    ecoUpgradeUsd: 14_000_000,
  },
  {
    ...
    buyPriceUsd: 375_000_000, leasePerQuarterUsd: 3_074_000,
    ecoUpgradeUsd: 37_500_000,
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 395_000_000, leasePerQuarterUsd: 3_238_000,
    ecoUpgradeUsd: 39_500_000,
  },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    buyPriceUsd: 360_000_000, leasePerQuarterUsd: 2_951_000,
    ecoUpgradeUsd: 36_000_000,
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    rangeKm: 6_110, fuelBurnPerKm: 2.9,
    buyPriceUsd: 130_000_000, leasePerQuarterUsd: 1_066_000,
